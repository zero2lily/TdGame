...
enum class ResID
{
	...
	Tex_UIUpgradeArcher,
	Tex_UIUpgradeGunner,
	Tex_UIUpgradeHoveredAxeman,
	Tex_UIUpgradeHoveredArcher,
	Tex_UIUpgradeHoveredGunner,
	Tex_UIHomeAvatar,
	Tex_UIPlayerAvatar,
	Tex_UIHeart,
	Tex_UICoin,
...
public:
	bool load_from_file(SDL_Renderer* renderer)
	{
		...
		texture_pool[ResID::Tex_EnemyDead] = IMG_LoadTexture(renderer, "resources/enemy_dead.png");
		...
		texture_pool[ResID::Tex_UIUpgradeAxeman] = IMG_LoadTexture(renderer, "resources/ui_upgrade_axeman.png");
		texture_pool[ResID::Tex_UIUpgradeArcher] = IMG_LoadTexture(renderer, "resources/ui_upgrade_archer.png");
		texture_pool[ResID::Tex_UIUpgradeGunner] = IMG_LoadTexture(renderer, "resources/ui_upgrade_gunner.png");
		texture_pool[ResID::Tex_UIUpgradeHoveredAxeman] = IMG_LoadTexture(renderer, "resources/ui_upgrade_hovered_axeman.png");
		texture_pool[ResID::Tex_UIUpgradeHoveredArcher] = IMG_LoadTexture(renderer, "resources/ui_upgrade_hovered_archer.png");
		texture_pool[ResID::Tex_UIUpgradeHoveredGunner] = IMG_LoadTexture(renderer, "resources/ui_upgrade_hovered_gunner.png");
		...
		texture_pool[ResID::Tex_UIEnemyShow] = IMG_LoadTexture(renderer, "resources/ui_enemy_show.png");
		...
		sound_pool[ResID::Sound_TowerOpenMenu] = Mix_LoadWAV("resources/Sound_tower_open_menu.mp3");
		sound_pool[ResID::Sound_TowerMouseOveredIcon] = Mix_LoadWAV("resources/Sound_tower_mouse_overed_icon.mp3");
