...
public:
	...
	struct PlayerTemplate
	{
		...
		double normal_attack_damage = 0;      //每帧对敌人的伤害
...
public:
	...
	const double num_initial_hp = 10;       //初始房屋血量
	const double num_initial_coin = 1000;    //初始金币数量
	const double num_coin_per_prop = 10;    //得到道具获得的金币数量
